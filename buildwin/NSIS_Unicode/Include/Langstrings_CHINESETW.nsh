...
LangString Installer ${LANG_CHINESETW} "安裝程式"

#LangString Uninstaller ${LANG_ENGLISH} "uninstaller"
LangString Uninstaller ${LANG_CHINESETW} "移除安裝程式"
...
LangString Label_CleanUp_Text ${LANG_CHINESETW} "按下表列之一來選擇/取消, 或者全選(建議值)來移除安裝項目."

#LangString BT_Uninstall_Selected_CleanUp ${LANG_ENGLISH} "Uninstall Selected"
LangString BT_Uninstall_Selected_CleanUp ${LANG_CHINESETW} "移除選擇項目"

#LangString BT_SelectAll_CleanUp ${LANG_ENGLISH} "Select ALL"
LangString BT_SelectAll_CleanUp ${LANG_CHINESETW} "選擇全部"

#LangString BT_UnselectAll_CleanUp ${LANG_ENGLISH} "Unselect ALL"
LangString BT_UnselectAll_CleanUp ${LANG_CHINESETW} "取消選取全部"

#LangString LB_CleanUp ${LANG_ENGLISH} "Listbox Text"
LangString LB_CleanUp ${LANG_CHINESETW} "列表文字"

#LangString BT_FullScan_CleanUp ${LANG_ENGLISH} "Scan HDD ..."
LangString BT_FullScan_CleanUp ${LANG_CHINESETW} "掃描硬碟 ..."
...
LangString SecDeleteNavobjFile_Desc ${LANG_CHINESETW} "刪除組態目錄中的 'navobj.xml' 此檔包含航跡."

#LangString SecDeleteLogFile_Desc ${LANG_ENGLISH} "Deletes the OpenCPN log file 'opencpn.log'."
LangString SecDeleteLogFile_Desc ${LANG_CHINESETW} "刪除 OpenCPN 紀錄檔 'opencpn.log'."

#LangString SecGrpShortcuts_Desc ${LANG_ENGLISH} "Creates shortcuts in both, the Start Menu and on the Desktop."
LangString SecGrpShortcuts_Desc ${LANG_CHINESETW} "在桌面與開始功能表建立捷徑."
...
LangString SecShortcutStartmenu_Desc ${LANG_CHINESETW} "在開始功能表建立 OpenCPN 與移除安裝程式的捷徑 - 在下一頁進行設定."

#LangString SecShortcutDesktop_Desc ${LANG_ENGLISH} "Creates a shortcut for OpenCPN on the Desktop."
LangString SecShortcutDesktop_Desc ${LANG_CHINESETW} "在桌面建立 OpenCPN 捷徑."
...
LangString SecSetConfig_Desc ${LANG_CHINESETW} "預先設定 OpenCPN 的顯示語系與圖資目錄.選擇後會開啟另一個頁面進行設定."

#LangString UnSecDeleteConfigFolder_Desc ${LANG_ENGLISH} "Deletes the config folder and all its files and subdirectories."
LangString UnSecDeleteConfigFolder_Desc ${LANG_CHINESETW} "刪除組態資料夾與其中所有檔案與子目錄."

#LangString Uninstall_Link ${LANG_ENGLISH} "Uninstall OpenCPN 3.3.1117"
LangString Uninstall_Link ${LANG_CHINESETW} "移除安裝 OpenCPN 3.3.1117"

#LangString Page_TypeInst_Title ${LANG_ENGLISH} "Previous Installations"
LangString Page_TypeInst_Title ${LANG_CHINESETW} "前一次安裝"
...
LangString Page_TypeInst_Subtitle ${LANG_CHINESETW} "找到 $MULTIPLE_INSTALLS OpenCPN 安裝.$\r$\n選擇您要如何安裝 OpenCPN."

#LangString Page_TypeInst_Title_1 ${LANG_ENGLISH} "Already Installed"
LangString Page_TypeInst_Title_1 ${LANG_CHINESETW} "已經安裝"

#LangString Page_TypeInst_Subtitle_1 ${LANG_ENGLISH} "Found installed version of OpenCPN.$\r$\nChoose how you want to install OpenCPN."
LangString Page_TypeInst_Subtitle_1 ${LANG_CHINESETW} "發現已安裝的 OpenCPN.$\r$\n選擇您要如何安裝 OpenCPN."

#LangString Page_TypeInst_Title_Exists ${LANG_ENGLISH} "Version Already Installed"
LangString Page_TypeInst_Title_Exists ${LANG_CHINESETW} "版本已安裝"

#LangString Page_TypeInst_Subtitle_Exists ${LANG_ENGLISH} "OpenCPN 3.3.1117 is already installed.$\r$\nChoose how you want to install OpenCPN."
LangString Page_TypeInst_Subtitle_Exists ${LANG_CHINESETW} "OpenCPN 3.3.1117 已安裝.$\r$\n選擇您要如何安裝 OpenCPN."
...
LangString Label_TypeInst_Reinstall_Text ${LANG_CHINESETW} "OpenCPN 3.3.1117 已經安裝在您的系統上. 您可以使用先前的設定值重新安裝此版本. 如果您希望以不同的設定值來安裝, 請先移除現有版本, 按下一步繼續."

#LangString RB_Reinstall_TypeInst_Text ${LANG_ENGLISH} "Reinstall using previous settings"
LangString RB_Reinstall_TypeInst_Text ${LANG_CHINESETW} "使用先前設定重新安裝"
...
LangString Label_TypeInst_Upgrade_Text ${LANG_CHINESETW} "有一份較舊的 OpenCPN 已安裝在您的系統上. 選擇您要進行的安裝方式並按下一步繼續."

#LangString RB_Upgrade_TypeInst_Text ${LANG_ENGLISH} "Upgrade OpenCPN using previous settings (recommended)"
LangString RB_Upgrade_TypeInst_Text ${LANG_CHINESETW} "使用先前的設定值升級 OpenCPN 版本(建議選項)"
...
LangString Label_TypeInst_Downgrade_Text ${LANG_CHINESETW} "有一份較新版本的 OpenCPN 已安裝在您的系統上. 建議您不要降級至舊版本. 選擇您要進行的安裝方式並按下一步繼續."

#LangString RB_Downgrade_TypeInst_Text ${LANG_ENGLISH} "Downgrade OpenCPN using previous settings (recommended)"
LangString RB_Downgrade_TypeInst_Text ${LANG_CHINESETW} "使用先前的設定值降級 OpenCPN 版本(建議選項)"
...
LangString Label_TypeInst_Parallel_Text ${LANG_CHINESETW} "設定程式偵測到您有數個版本的 OpenCPN 安裝在您的系統上. 建議您一次僅安裝一個版本. 選擇您要進行的安裝方式並按下一步繼續."

#LangString RB_Parallel_TypeInst_Text ${LANG_ENGLISH} "Parallel Installation (advanced users)"
LangString RB_Parallel_TypeInst_Text ${LANG_CHINESETW} "平行安裝 (進階使用者)"

#LangString EmptyString ${LANG_ENGLISH} ""
LangString EmptyString ${LANG_CHINESETW} ""

#LangString Show_Readme_Text ${LANG_ENGLISH} "Show Install Log file"
LangString Show_Readme_Text ${LANG_CHINESETW} "顯示安裝紀錄檔"

#LangString Finish_Link_Text ${LANG_ENGLISH} "OpenCPN website (Internet connection required)"
LangString Finish_Link_Text ${LANG_CHINESETW} "OpenCPN 網頁 (需要連結網際網路)"

#LangString Finish_Link_URL ${LANG_ENGLISH} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.1117"
LangString Finish_Link_URL ${LANG_CHINESETW} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.1117"
...
LangString Msg_UAC_Admin_Retry ${LANG_CHINESETW} "此項 $Inst_Or_Uninst 需要管理者權限!$\r$\n請以管理者帳號登入後再重試."

#LangString Msg_UAC_Admin_Abort ${LANG_ENGLISH} "This $Inst_Or_Uninst requires admin privileges, aborting!"
LangString Msg_UAC_Admin_Abort ${LANG_CHINESETW} "此項 $Inst_Or_Uninst 需要管理者權限, 結束中!"

#LangString Msg_UAC_Logon_Abort ${LANG_ENGLISH} "Logon service not running, aborting!"
LangString Msg_UAC_Logon_Abort ${LANG_CHINESETW} "登入服務未執行, 結束中!"

#LangString Msg_UAC_No_Elevation ${LANG_ENGLISH} "Unable to elevate , error $0"
LangString Msg_UAC_No_Elevation ${LANG_CHINESETW} "無法升級 , 錯誤 $0"
...
LangString Msg_Error_Remove_InstDir ${LANG_CHINESETW} "目錄未清空，安裝目錄$\r$\n'$INSTDIR'$\r$\n無法移除."

#LangString Msg_Path_Invalid ${LANG_ENGLISH} "The entered path is invalid!$\r$\n$\r$\nPlease check your input."
LangString Msg_Path_Invalid ${LANG_CHINESETW} "輸入路徑錯誤!$\r$\n$\r$\n請檢查輸入."
...
LangString Msg_Path_Installation_Exists ${LANG_CHINESETW} "在輸入路徑中已存在一份 OpenCPN 版本.$\r$\n如果您希望使用此路徑, 請先移除已安裝版本. 或者選擇其他路徑安裝."
...
LangString Msg_Uninstall_Old_Versions ${LANG_CHINESETW} "設定程式偵測到至少有一份較舊的 OpenCPN 與新的版本控制不相容.$\r$\n建議您先移除所有舊的安裝(這不會影響您的既有設定), 並清理登錄機碼.$\r$\n如果您選擇是, 在下一頁會出現一個所有已安裝位置清單, 供您選擇想要移除的項目.$\r$\n如果您認為可能還有其他位置, 您也可以對整顆硬碟進行掃描(注意:可能耗上一段時間)來找出所有已安裝位置(建議選項).$\r$\n$\r$\n您要移除舊版本嗎?"

#LangString Msg_Not_All_Old_Uninstalled ${LANG_ENGLISH} "You have not uninstalled all previous installations.$\r$\n$\r$\nDo you want to continue anyway?"
LangString Msg_Not_All_Old_Uninstalled ${LANG_CHINESETW} "您尚未移除所有先前的安裝.$\r$\n$\r$\n您仍要繼續嗎?"
...
LangString Msg_Uninstaller_Param_Help ${LANG_CHINESETW} "移除安裝 輔助說明$\r$\n$\r$\n使用命令列或捷徑來執行移除安裝程式:$\r$\n$INSTDIR\Uninstall 3.3.1117.exe [/?] | [/S], [/type=X]$\r$\n$\r$\nParametre:$\r$\n/?$\t顯示此輔助說明$\r$\n/S$\t以靜默模式執行移除安裝程式$\r$\n$\t如果未輸入任何參數則進行完整移除$\r$\n/type=X$\tX 必須為 1 到 5 之間的數字$\r$\n$\t1 = 僅移除程式$\r$\n$\t2 = 僅移除程式 + 預設 RegKey$\r$\n$\t3 = 移除程式 + 組態設定資料夾$\r$\n$\t保留預設 RegKey$\r$\n$\t4 = 僅刪除組態設定資料夾$\r$\n$\t5 = 僅刪除預設 RegKey$\r$\n$\r$\n輸入其他的數字將離開程式不做任何更動."
...
LangString License_Message ${LANG_CHINESETW} "OpenCPN is software libre. You are encouraged and legally entitled to copy, reinstall, modify, and redistribute this program for yourself and your friends under the terms of the GPL. $\r$\nSmooth sailing!"
...
LangString Installer_Unsupported_XP_SP_Version ${LANG_CHINESETW} "Your Windows XP Service Pack version is not supported (it's too old)!$\r$\nYou need at least Windows XP SP3."
