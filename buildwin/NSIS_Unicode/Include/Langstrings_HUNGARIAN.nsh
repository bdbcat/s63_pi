...
LangString Installer ${LANG_HUNGARIAN} ""
	
#LangString Uninstaller ${LANG_ENGLISH} "uninstaller"
LangString Uninstaller ${LANG_HUNGARIAN} ""
...
LangString SecShortcutStartmenu_Desc ${LANG_HUNGARIAN} ""

#LangString SecShortcutDesktop_Desc ${LANG_ENGLISH} "Creates a shortcut for OpenCPN on the Desktop."
LangString SecShortcutDesktop_Desc ${LANG_HUNGARIAN} ""
...
LangString SecSetConfig_Desc ${LANG_HUNGARIAN} ""

#LangString UnSecDeleteConfigFolder_Desc ${LANG_ENGLISH} "Deletes the config folder and all its files and subdirectories."
LangString UnSecDeleteConfigFolder_Desc ${LANG_HUNGARIAN} ""

#LangString Uninstall_Link ${LANG_ENGLISH} "Uninstall OpenCPN 3.0.2"
LangString Uninstall_Link ${LANG_HUNGARIAN} ""

#LangString Page_TypeInst_Title ${LANG_ENGLISH} "Previous Installations"
LangString Page_TypeInst_Title ${LANG_HUNGARIAN} ""
...
LangString Page_TypeInst_Subtitle ${LANG_HUNGARIAN} ""	

#LangString Page_TypeInst_Title_1 ${LANG_ENGLISH} "Already Installed"
LangString Page_TypeInst_Title_1 ${LANG_HUNGARIAN} ""

#LangString Page_TypeInst_Subtitle_1 ${LANG_ENGLISH} "Found installed version of OpenCPN.$\r$\nChoose how you want to install OpenCPN."
LangString Page_TypeInst_Subtitle_1 ${LANG_HUNGARIAN} ""	

#LangString Page_TypeInst_Title_Exists ${LANG_ENGLISH} "Version Already Installed"
LangString Page_TypeInst_Title_Exists ${LANG_HUNGARIAN} ""

#LangString Page_TypeInst_Subtitle_Exists ${LANG_ENGLISH} "OpenCPN 3.0.2 is already installed.$\r$\nChoose how you want to install OpenCPN."
LangString Page_TypeInst_Subtitle_Exists ${LANG_HUNGARIAN} ""	

#LangString Label_TypeInst_Reinstall_Text ${LANG_ENGLISH} "OpenCPN 3.0.2 is already installed on your system. You can reinstall the version now using the previous settings. If you wish to install the program with different settings, cancel installation and un-install the existing version first. Click Next to continue."
LangString Label_TypeInst_Reinstall_Text ${LANG_HUNGARIAN} ""

#LangString RB_Reinstall_TypeInst_Text ${LANG_ENGLISH} "Reinstall using previous settings"
LangString RB_Reinstall_TypeInst_Text ${LANG_HUNGARIAN} ""
...
LangString Label_TypeInst_Upgrade_Text ${LANG_HUNGARIAN} ""

#LangString RB_Upgrade_TypeInst_Text ${LANG_ENGLISH} "Upgrade OpenCPN using previous settings (recommended)"
LangString RB_Upgrade_TypeInst_Text ${LANG_HUNGARIAN} ""
...
LangString Label_TypeInst_Downgrade_Text ${LANG_HUNGARIAN} ""

#LangString RB_Downgrade_TypeInst_Text ${LANG_ENGLISH} "Downgrade OpenCPN using previous settings (recommended)"
LangString RB_Downgrade_TypeInst_Text ${LANG_HUNGARIAN} ""
...
LangString Label_TypeInst_Parallel_Text ${LANG_HUNGARIAN} ""

#LangString RB_Parallel_TypeInst_Text ${LANG_ENGLISH} "Parallel Installation (advanced users)"
LangString RB_Parallel_TypeInst_Text ${LANG_HUNGARIAN} ""

#LangString EmptyString ${LANG_ENGLISH} ""
LangString EmptyString ${LANG_HUNGARIAN} ""

#LangString Show_Readme_Text ${LANG_ENGLISH} "Show Install Log file"
LangString Show_Readme_Text ${LANG_HUNGARIAN} ""

#LangString Finish_Link_Text ${LANG_ENGLISH} "OpenCPN website (Internet connection required)"
LangString Finish_Link_Text ${LANG_HUNGARIAN} ""

#LangString Finish_Link_URL ${LANG_ENGLISH} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.0.2"
LangString Finish_Link_URL ${LANG_HUNGARIAN} ""
...
LangString Msg_Error_Remove_InstDir ${LANG_HUNGARIAN} ""

#LangString Msg_Path_Invalid ${LANG_ENGLISH} "The entered path is invalid!$\r$\n$\r$\nPlease check your input."
LangString Msg_Path_Invalid ${LANG_HUNGARIAN} ""
...
LangString Msg_Path_Installation_Exists ${LANG_HUNGARIAN} ""
...
LangString License_Message ${LANG_HUNGARIAN} ""
...
LangString Installer_Unsupported_XP_SP_Version ${LANG_HUNGARIAN} ""
