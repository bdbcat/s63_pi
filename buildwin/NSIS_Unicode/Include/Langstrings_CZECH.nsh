...
LangString Installer ${LANG_CZECH} "instalátor"

#LangString Uninstaller ${LANG_ENGLISH} "uninstaller"
LangString Uninstaller ${LANG_CZECH} "deinstalátor"
...
LangString Installer_Unsupported_Windows_Version ${LANG_CZECH} "Vaše verze Windows není podporována (je moc stará)!$\r$\nPotřebujete alespoň Windows NT/2000."

#LangString Installer_Running ${LANG_ENGLISH} "The installer is already running."
LangString Installer_Running ${LANG_CZECH} "Instalátor již je spuštěn."
...
LangString LangDialog_Title ${LANG_CZECH} "Instalace OpenCPN 3.3.1117"
...
LangString text_please_wait_1 ${LANG_CZECH} "... prosím čekejte!"

#LangString Scanning_HDD ${LANG_ENGLISH} "Scanning HDD ..."
LangString Scanning_HDD ${LANG_CZECH} "Skenuji disk ..."

#LangString OCPN_Scanning_HDD ${LANG_ENGLISH} "OpenCPN: Scan HDD ..., please wait!"
LangString OCPN_Scanning_HDD ${LANG_CZECH} "OpenCPN: Sken disku ..., prosím čekejte!"

#LangString Search_old_installations ${LANG_ENGLISH} "Searching for old installations"
LangString Search_old_installations ${LANG_CZECH} "Hledání starších instalací"

#LangString Install_Location_Default ${LANG_ENGLISH} "Install Locations by default paths (may not find all)"
LangString Install_Location_Default ${LANG_CZECH} "Místa instalace podle výchozích cest (nemusí najít vše)"

#LangString Install_Location_HDD_Scan ${LANG_ENGLISH} "Install Location by full HDD scan (most reliable)"
LangString Install_Location_HDD_Scan ${LANG_CZECH} "Místo instalace pomocí skenu celého disku (nejspolehlivější)"
...
LangString Label_CleanUp_Text ${LANG_CZECH} "Klikněte na položku seznamu pro její označení/ zrušení nebo Označit VŠE (doporučeno) a pak odinstalujte vybrané."

#LangString BT_Uninstall_Selected_CleanUp ${LANG_ENGLISH} "Uninstall Selected"
LangString BT_Uninstall_Selected_CleanUp ${LANG_CZECH} "Odinstalovat vybrané"

#LangString BT_SelectAll_CleanUp ${LANG_ENGLISH} "Select ALL"
LangString BT_SelectAll_CleanUp ${LANG_CZECH} "Označit VŠE"

#LangString BT_UnselectAll_CleanUp ${LANG_ENGLISH} "Unselect ALL"
LangString BT_UnselectAll_CleanUp ${LANG_CZECH} "Zrušit VŠE"

#LangString LB_CleanUp ${LANG_ENGLISH} "Listbox Text"
LangString LB_CleanUp ${LANG_CZECH} "Text listboxu"

#LangString BT_FullScan_CleanUp ${LANG_ENGLISH} "Scan HDD ..."
LangString BT_FullScan_CleanUp ${LANG_CZECH} "Sken disku ..."
...
LangString Label_SetConfig_Text ${LANG_CZECH} "Nastavit výchozí možnosti pro program OpenCPN.$\r$\nToto nastavení je uloženo v souboru opencpn.ini."

#LangString Page_Confirm_Title ${LANG_ENGLISH} "Ready to Install"
LangString Page_Confirm_Title ${LANG_CZECH} "Připraven k instalaci"

#LangString Page_Confirm_Subtitle ${LANG_ENGLISH} "Check the installation options"
LangString Page_Confirm_Subtitle ${LANG_CZECH} "Zkontrolovat možnosti instalace"

#LangString Installation_Type ${LANG_ENGLISH} "Setup type"
LangString Installation_Type ${LANG_CZECH} "Typ instalace"

#LangString Installation_Directory ${LANG_ENGLISH} "Destination location"
LangString Installation_Directory ${LANG_CZECH} "Cílové umístění"

#LangString Create_Shortcuts ${LANG_ENGLISH} "Create shortcuts"
LangString Create_Shortcuts ${LANG_CZECH} "Vytvořit zástupce"

#LangString Type_Reinstall ${LANG_ENGLISH} "Reinstallation"
LangString Type_Reinstall ${LANG_CZECH} "Přeinstalovat"
...
LangString Type_Parallel_Installation ${LANG_CZECH} "Souběžná instalace"
...
LangString SecDeleteConfigFile_Desc ${LANG_CZECH} "Smaže konfigurační soubor. Tento soubor obsahuje také trasy a trasové body."

#LangString SecDeleteChartDB_Desc ${LANG_ENGLISH} "Deletes the Chart DB file."
LangString SecDeleteChartDB_Desc ${LANG_CZECH} "Smaže soubor DB map."

#LangString SecDeleteSENC_Desc ${LANG_ENGLISH} "Deletes the SENC subfolder which helds the Bitmaps and S57 chart cache files."
LangString SecDeleteSENC_Desc ${LANG_CZECH} "Smaže podsložku SENC, která obsahuje bitmapy a cache S57 map."

#LangString SecDeleteCM93_Desc ${LANG_ENGLISH} "Deletes the cm93 subfolder which helds the cached cm93 chart outlines."
LangString SecDeleteCM93_Desc ${LANG_CZECH} "Smaže podsložku cm93, která obsahuje cache obrysů map CM93."
...
LangString SecDeleteNavobjFile_Desc ${LANG_CZECH} "Smaže soubor 'navobj.xml' ve složce nastavení. Tento soubor obsahuje stopy."

#LangString SecDeleteLogFile_Desc ${LANG_ENGLISH} "Deletes the OpenCPN log file 'opencpn.log'."
LangString SecDeleteLogFile_Desc ${LANG_CZECH} "Smaže soubor logu OpenCPN 'opencpn.log'."

#LangString SecGrpShortcuts_Desc ${LANG_ENGLISH} "Creates shortcuts in both, the Start Menu and on the Desktop."
LangString SecGrpShortcuts_Desc ${LANG_CZECH} "Vytvoří zástupce na ploše i v nabídce Start."
...
LangString SecShortcutStartmenu_Desc ${LANG_CZECH} "Vytvoří zástupce pro OpenCPN a deinstalátor v nabádce Start - nastavitelné na další stránce."

#LangString SecShortcutDesktop_Desc ${LANG_ENGLISH} "Creates a shortcut for OpenCPN on the Desktop."
LangString SecShortcutDesktop_Desc ${LANG_CZECH} "Vytvoří zástupce pro OpenCPN na ploše."
...
LangString SecSetConfig_Desc ${LANG_CZECH} "Přednastavit jazyk a složky map pro OpenCPN. Pokud je vybráno, je zobrazena zvláštní stránka pro nastavení."

#LangString UnSecDeleteConfigFolder_Desc ${LANG_ENGLISH} "Deletes the config folder and all its files and subdirectories."
LangString UnSecDeleteConfigFolder_Desc ${LANG_CZECH} "Smaže složku s nastavením a všechny její soubory a podsložky."

#LangString Uninstall_Link ${LANG_ENGLISH} "Uninstall OpenCPN 3.3.1117"
LangString Uninstall_Link ${LANG_CZECH} "Odinstalovat OpenCPN 3.3.1117"
...
LangString Page_TypeInst_Subtitle ${LANG_CZECH} "$MULTIPLE_INSTALLS instalace OpenCPN nalezeny.$\r$\nVyberte, jak chcete OpenCPN nainstalovat."

#LangString Page_TypeInst_Title_1 ${LANG_ENGLISH} "Already Installed"
LangString Page_TypeInst_Title_1 ${LANG_CZECH} "Již nainstalováno"

#LangString Page_TypeInst_Subtitle_1 ${LANG_ENGLISH} "Found installed version of OpenCPN.$\r$\nChoose how you want to install OpenCPN."
LangString Page_TypeInst_Subtitle_1 ${LANG_CZECH} "Nalezena nainstalovaná verze OpenCPN.$\r$\nVyberte, jak chcete OpenCPN nainstalovat."
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_CZECH} "OpenCPN 3.3.1117 je již nainstalováno.$\r$\nVyberte, jak chcete OpenCPN nainstalovat."
...
LangString Label_TypeInst_Reinstall_Text ${LANG_CZECH} "OpenCPN 3.3.1117 je již na Vašem systému nainstalováno. Nyní můžete přeinstalovat verzi s původní nastavením. Pokud chcete nainstalovat program s jiným nastavením, zrušte instalaci a odinstalujte napřed původní verzi. Klikněte na Další pro pokračování."
...
LangString Label_TypeInst_Upgrade_Text ${LANG_CZECH} "Starší verze OpenCPN je nainstalována na Vašem systému. Zvolte typ instalace a klikněte na Další pro pokračování."

#LangString RB_Upgrade_TypeInst_Text ${LANG_ENGLISH} "Upgrade OpenCPN using previous settings (recommended)"
LangString RB_Upgrade_TypeInst_Text ${LANG_CZECH} "Povýšit OpenCPN s původním nastavením (doporučeno)"
...
LangString Label_TypeInst_Downgrade_Text ${LANG_CZECH} "Novější verze OpenCPN je nainstalována na Vašem systému. Není doporučováno downgradovat na starší verzi. Zvolte typ instalace, který chcete provést a klikněte na Další pro pokračování."

#LangString RB_Downgrade_TypeInst_Text ${LANG_ENGLISH} "Downgrade OpenCPN using previous settings (recommended)"
LangString RB_Downgrade_TypeInst_Text ${LANG_CZECH} "Downgrade OpenCPN s původním nastavením (doporučeno)"
...
LangString Label_TypeInst_Parallel_Text ${LANG_CZECH} "Instalátor detekoval několik instalovaných verzí OpenCPN na Vašem systému. Je doporučeno mít instalovánu pouze jednu verzi OpenCPN. Vyberte operaci, kterou chcete provést a klikněte na Další pro pokračování."

#LangString RB_Parallel_TypeInst_Text ${LANG_ENGLISH} "Parallel Installation (advanced users)"
LangString RB_Parallel_TypeInst_Text ${LANG_CZECH} "Paralelní instalace (pokročilí uživatelé)"
...
LangString Show_Readme_Text ${LANG_CZECH} "Zobraz log instalace"

#LangString Finish_Link_Text ${LANG_ENGLISH} "OpenCPN website (Internet connection required)"
LangString Finish_Link_Text ${LANG_CZECH} "Web OpenCPN (Je potřeba připojení k Internetu)"

#LangString Finish_Link_URL ${LANG_ENGLISH} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.1117"
LangString Finish_Link_URL ${LANG_CZECH} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.1117"
...
LangString Msg_UAC_Admin_Retry ${LANG_CZECH} "Tento $Inst_Or_Uninst vyžaduje přístup administrátora!$\r$\nProsím, přihlaste se jako Administrator a zkuste to znovu."

#LangString Msg_UAC_Admin_Abort ${LANG_ENGLISH} "This $Inst_Or_Uninst requires admin privileges, aborting!"
LangString Msg_UAC_Admin_Abort ${LANG_CZECH} "Tento $Inst_Or_Uninst vyžaduje administrátorská oprávnění, končím!"

#LangString Msg_UAC_Logon_Abort ${LANG_ENGLISH} "Logon service not running, aborting!"
LangString Msg_UAC_Logon_Abort ${LANG_CZECH} "Logon služba neběží, končím!"

#LangString Msg_UAC_No_Elevation ${LANG_ENGLISH} "Unable to elevate , error $0"
LangString Msg_UAC_No_Elevation ${LANG_CZECH} "Nemohu povýšit , chyba $0"
...
LangString Msg_Error_Remove_InstDir ${LANG_CZECH} "Instalační složka$\r$\n'$INSTDIR'$\r$\nnelze odstranit, protože není prázdná."
...
LangString Msg_Path_Installation_Exists ${LANG_CZECH} "Instalace OpenCPN v zadané cestě již existuje.$\r$\nPokud chcete použít tuto cestu, nejprve odinstalujte tuto verzi. Nebo pro tuto instalaci zvolte jinou cestu."
...
LangString Msg_Uninstall_Old_Versions ${LANG_CZECH} "Instalátor detekoval alespoň jednu starší verzi OpenCPN, která není komúatibilní s novou správou verzí.$\r$\nJe doporučeno nejprve odstranit všechny tyto instalace (neovlivní to Vaše konfigurační soubory) a vyčistit Registr.$\r$\nPokud na dalši stránce kliknete na Ano, bude zobrazen seznam všech umístění instalace a budete mít možnost vybrat instalace, které chcete odebrat.$\r$\nPokud si nejste jist dalšími možnými instalacemi kromě těch na seznamu, můžete provést sken celého pevného disku (POZOR: může to trvat několik minut), aby byly nalezeny všechny umístění instalace (doporučeno).$\r$\n$\r$\nChcete odinstalovat předchozí verze?"

#LangString Msg_Not_All_Old_Uninstalled ${LANG_ENGLISH} "You have not uninstalled all previous installations.$\r$\n$\r$\nDo you want to continue anyway?"
LangString Msg_Not_All_Old_Uninstalled ${LANG_CZECH} "Neodinstaloval jste všechny předchozí instalace.$\r$\n$\r$\nChcete přesto pokračovat?"
...
LangString Msg_Uninstaller_Param_Help ${LANG_CZECH} "Nápověda deinstalátoru$\r$\n$\r$\nPoužijte příkazovou řádku nebo zástupce ke spuštění odinstalátoru:$\r$\n$INSTDIR\Uninstall 3.3.1117.exe [/?] | [/S], [/type=X]$\r$\n$\r$\nParametrys:$\r$\n/?$\tzobrazí tuto nápovědu$\r$\n/S$\tspustí deinstalátor v tichém módu$\r$\n$\tprovede kompletní odinstalaci, pokud je spuštěn bez parametrů$\r$\n/type=X$\tX musí být číslo mezi 1 a 5$\r$\n$\t1 = Odstraní jen programové soubory$\r$\n$\t2 = Odstraní jen programové soibory + přednastavení RegKey$\r$\n$\t3 = Odstraní programové soubory + složku nastavení$\r$\n$\tzachová přednastavení RegKey$\r$\n$\t4 = Smaže jen složku nastavení$\r$\n$\t5 = Smaže jen přednastavení RegKey$\r$\n$\r$\nVložení jakéhokoli jiného čísla ukončí odinstalátor se zprávou bez toho, aby cokoli odstranil nebo smazal."
...
LangString Msg_Unknown_Type_Param ${LANG_CZECH} "Vložená hodnota '$9' pro parametr typu není platná!$\r$\nPoužijte $INSTDIR\Uninstall 3.3.1117.exe /?$\r$\npro zobrazení seznamu povolených hodnot."

;added on 2010-10-16
#LangString SecGrpShortcuts_Text ${LANG_ENGLISH} "Create Shortcuts"
LangString SecGrpShortcuts_Text ${LANG_CZECH} "Vytvořit zástupce"

#LangString SecShortcutStartmenu_Text ${LANG_ENGLISH} "Add Shortcuts to the Start Menu"
LangString SecShortcutStartmenu_Text ${LANG_CZECH} "Vytvořit zástupce v nabídce Start"

#LangString SecShortcutDesktop_Text ${LANG_ENGLISH} "Create Shortcut on the Desktop"
LangString SecShortcutDesktop_Text ${LANG_CZECH} "Vytvořit zástupce na ploše"

#LangString Installation_Delete_Config ${LANG_ENGLISH} "Delete (existing) Config Subdirectories/ Files"
LangString Installation_Delete_Config ${LANG_CZECH} "Smazat (existující) konfigurační podsložky/ soubory"

;added on 2010-10-17
#LangString Banner_Scan_Drive ${LANG_ENGLISH} "Scanning Drive $9"
LangString Banner_Scan_Drive ${LANG_CZECH} "Skenuji disk $9"

#LangString Banner_Installation_Found_Singular ${LANG_ENGLISH} "Found $counter_tmp installation"
LangString Banner_Installation_Found_Singular ${LANG_CZECH} "Nalezena $counter_tmp instalace"

#LangString Banner_Installation_Found_Plural ${LANG_ENGLISH} "Found $counter_tmp installations"
LangString Banner_Installation_Found_Plural ${LANG_CZECH} "Nalezeny $counter_tmp instalace"

;added on 2010-10-18
#LangString UnSecDeleteConfigFolder_Text ${LANG_ENGLISH} "Delete Config folder"
LangString UnSecDeleteConfigFolder_Text ${LANG_CZECH} "Smazat složku konfigurace"

;added on 2010-10-21
#LangString Uninstall_Folder_Name ${LANG_ENGLISH} "Uninstall"
LangString Uninstall_Folder_Name ${LANG_CZECH} "Odinstalovat"

;added on 2011-06-13
#LangString ^NameDA ${LANG_ENGLISH} "OpenCPN Version 3.3.1117"
LangString ^NameDA ${LANG_CZECH} "OpenCPN Verze 3.3.1117"
...
LangString License_Message ${LANG_CZECH} "OpenCPN je svobodný software. Můžete a budeme rádi, když ho budete kopírovat, instalovat, modifikovat a šířit ať už pro sebe nebo své přátele, pokud dodržíte podmínky licence GPL. $\r$\nŠťastnou plavbu!"
