...
LangString Installer ${LANG_PORTUGUESE} "installer"

#LangString Uninstaller ${LANG_ENGLISH} "uninstaller"
LangString Uninstaller ${LANG_PORTUGUESE} "uninstaller"
...
LangString Installer_Unsupported_Windows_Version ${LANG_PORTUGUESE} "Your Windows version is not supported (it's too old)!$\r$\nYou need at least Windows XP SP3."

#LangString Installer_Running ${LANG_ENGLISH} "The installer is already running."
LangString Installer_Running ${LANG_PORTUGUESE} "The installer is already running."

#LangString Uninstaller_Running ${LANG_ENGLISH} "The uninstaller is already running."
LangString Uninstaller_Running ${LANG_PORTUGUESE} "The uninstaller is already running."

#LangString LangDialog_Title ${LANG_ENGLISH} "OpenCPN 3.3.1117 Installation"
LangString LangDialog_Title ${LANG_PORTUGUESE} "OpenCPN 3.3.1117 Installation"

#LangString LangDialog_Text ${LANG_ENGLISH} "Please select a language:"
LangString LangDialog_Text ${LANG_PORTUGUESE} "Please select a language:"

#LangString text_please_wait_1 ${LANG_ENGLISH} "... please wait!"
LangString text_please_wait_1 ${LANG_PORTUGUESE} "... please wait!"

#LangString Scanning_HDD ${LANG_ENGLISH} "Scanning HDD ..."
LangString Scanning_HDD ${LANG_PORTUGUESE} "Scanning HDD ..."

#LangString OCPN_Scanning_HDD ${LANG_ENGLISH} "OpenCPN: Scan HDD ..., please wait!"
LangString OCPN_Scanning_HDD ${LANG_PORTUGUESE} "OpenCPN: Scan HDD ..., please wait!"

#LangString Search_old_installations ${LANG_ENGLISH} "Searching for old installations"
LangString Search_old_installations ${LANG_PORTUGUESE} "Searching for old installations"

#LangString Install_Location_Default ${LANG_ENGLISH} "Install Locations by default paths (may not find all)"
LangString Install_Location_Default ${LANG_PORTUGUESE} "Install Locations by default paths (may not find all)"

#LangString Install_Location_HDD_Scan ${LANG_ENGLISH} "Install Location by full HDD scan (most reliable)"
LangString Install_Location_HDD_Scan ${LANG_PORTUGUESE} "Install Location by full HDD scan (most reliable)"
...
LangString Label_CleanUp_Text ${LANG_PORTUGUESE} "Click on a list-item to select/ unselect it or Select ALL (recommended) and then Uninstall selected."

#LangString BT_Uninstall_Selected_CleanUp ${LANG_ENGLISH} "Uninstall Selected"
LangString BT_Uninstall_Selected_CleanUp ${LANG_PORTUGUESE} "Uninstall Selected"

#LangString BT_SelectAll_CleanUp ${LANG_ENGLISH} "Select ALL"
LangString BT_SelectAll_CleanUp ${LANG_PORTUGUESE} "Select ALL"

#LangString BT_UnselectAll_CleanUp ${LANG_ENGLISH} "Unselect ALL"
LangString BT_UnselectAll_CleanUp ${LANG_PORTUGUESE} "Unselect ALL"

#LangString LB_CleanUp ${LANG_ENGLISH} "Listbox Text"
LangString LB_CleanUp ${LANG_PORTUGUESE} "Listbox Text"

#LangString BT_FullScan_CleanUp ${LANG_ENGLISH} "Scan HDD ..."
LangString BT_FullScan_CleanUp ${LANG_PORTUGUESE} "Scan HDD ..."
...
LangString LAB_FullScan_CleanUp ${LANG_PORTUGUESE} "Scan the HDD for the most reliable detection.$\r$\nATTENTION: may last several minutes!"

#LangString Page_CleanUp_Title ${LANG_ENGLISH} "Uninstall older Version"
LangString Page_CleanUp_Title ${LANG_PORTUGUESE} "Uninstall older Version"

#LangString Page_CleanUp_Subtitle ${LANG_ENGLISH} "Incompatible version detected"
LangString Page_CleanUp_Subtitle ${LANG_PORTUGUESE} "Incompatible version detected"

#LangString CP_HEADER_TEXT ${LANG_ENGLISH} "Installation Settings"
LangString CP_HEADER_TEXT ${LANG_PORTUGUESE} "Installation Settings"

#LangString CP_HEADER_SUBTEXT ${LANG_ENGLISH} "Choose the settings for the installation"
LangString CP_HEADER_SUBTEXT ${LANG_PORTUGUESE} "Choose the settings for the installation"

#LangString CP_TOP ${LANG_ENGLISH} "Check or uncheck the options for the installation.$\r$\nClick 'Next' to continue."
LangString CP_TOP ${LANG_PORTUGUESE} "Check or uncheck the options for the installation.$\r$\nClick 'Next' to continue."

#LangString CP_INSTTYPE ${LANG_ENGLISH} "Installation type:"
LangString CP_INSTTYPE ${LANG_PORTUGUESE} "Installation type:"

#LangString CP_COMPLIST ${LANG_ENGLISH} "Adjust the settings individually:"
LangString CP_COMPLIST ${LANG_PORTUGUESE} "Adjust the settings individually:"

#LangString Page_SetConfig_Title ${LANG_ENGLISH} "Default configuration settings"
LangString Page_SetConfig_Title ${LANG_PORTUGUESE} "Default configuration settings"

#LangString Page_SetConfig_Subtitle ${LANG_ENGLISH} "Preconfigure settings for OpenCPN"
LangString Page_SetConfig_Subtitle ${LANG_PORTUGUESE} "Preconfigure settings for OpenCPN"

#LangString Select_Chart_Directory ${LANG_ENGLISH} "Please select a chart directory to add to OpenCPN"
LangString Select_Chart_Directory ${LANG_PORTUGUESE} "Please select a chart directory to add to OpenCPN"

#LangString BT_Browse_SetConfig_Text ${LANG_ENGLISH} "Browse..."
LangString BT_Browse_SetConfig_Text ${LANG_PORTUGUESE} "Browse..."

#LangString BT_DeleteAll_SetConfig_Text ${LANG_ENGLISH} "Delete ALL"
LangString BT_DeleteAll_SetConfig_Text ${LANG_PORTUGUESE} "Delete ALL"

#LangString BT_Delete_SetConfig_Text ${LANG_ENGLISH} "Delete"
LangString BT_Delete_SetConfig_Text ${LANG_PORTUGUESE} "Delete"

#LangString GB_ChartDir_SetConfig_Text ${LANG_ENGLISH} "Add Chart Directory"
LangString GB_ChartDir_SetConfig_Text ${LANG_PORTUGUESE} "Add Chart Directory"

#LangString CB_Language_SetConfig_Text ${LANG_ENGLISH} "Set OpenCPN program language to $LANG_NAME"
LangString CB_Language_SetConfig_Text ${LANG_PORTUGUESE} "Set OpenCPN program language to $LANG_NAME"

#LangString GB_Language_SetConfig_Text ${LANG_ENGLISH} "Set OpenCPN program language"
LangString GB_Language_SetConfig_Text ${LANG_PORTUGUESE} "Set OpenCPN program language"
...
LangString Label_SetConfig_Text ${LANG_PORTUGUESE} "Configure preconfig settings for the OpenCPN program.$\r$\nThese settings are saved in the file opencpn.ini."

#LangString Page_Confirm_Title ${LANG_ENGLISH} "Ready to Install"
LangString Page_Confirm_Title ${LANG_PORTUGUESE} "Ready to Install"

#LangString Page_Confirm_Subtitle ${LANG_ENGLISH} "Check the installation options"
LangString Page_Confirm_Subtitle ${LANG_PORTUGUESE} "Check the installation options"

#LangString Installation_Type ${LANG_ENGLISH} "Setup type"
LangString Installation_Type ${LANG_PORTUGUESE} "Setup type"

#LangString Installation_Directory ${LANG_ENGLISH} "Destination location"
LangString Installation_Directory ${LANG_PORTUGUESE} "Destination location"

#LangString Create_Shortcuts ${LANG_ENGLISH} "Create shortcuts"
LangString Create_Shortcuts ${LANG_PORTUGUESE} "Create shortcuts"

#LangString Type_Reinstall ${LANG_ENGLISH} "Reinstallation"
LangString Type_Reinstall ${LANG_PORTUGUESE} "Reinstallation"

#LangString Type_Upgrade ${LANG_ENGLISH} "Upgrade"
LangString Type_Upgrade ${LANG_PORTUGUESE} "Upgrade"

#LangString Type_Downgrade ${LANG_ENGLISH} "Downgrade"
LangString Type_Downgrade ${LANG_PORTUGUESE} "Downgrade"

#LangString Type_Parallel_Installation ${LANG_ENGLISH} "Parallel installation"
LangString Type_Parallel_Installation ${LANG_PORTUGUESE} "Parallel installation"

#LangString Type_Fresh_Installation ${LANG_ENGLISH} "New installation"
LangString Type_Fresh_Installation ${LANG_PORTUGUESE} "New installation"

#LangString Shortcuts ${LANG_ENGLISH} "Shortcuts"
LangString Shortcuts ${LANG_PORTUGUESE} "Shortcuts"

#LangString Create_Shortcut_Start_Menu ${LANG_ENGLISH} "in the Start Menu folder"
LangString Create_Shortcut_Start_Menu ${LANG_PORTUGUESE} "in the Start Menu folder"

#LangString Create_Shortcut_Desktop ${LANG_ENGLISH} "on the Desktop"
LangString Create_Shortcut_Desktop ${LANG_PORTUGUESE} "on the Desktop"

#LangString not_selected ${LANG_ENGLISH} "not selected"
LangString not_selected ${LANG_PORTUGUESE} "not selected"

#LangString text_none ${LANG_ENGLISH} "none"
LangString text_none ${LANG_PORTUGUESE} "none"

#LangString SecGrpResetConfig_Text ${LANG_ENGLISH} "Reset ALL OpenCPN configuration files"
LangString SecGrpResetConfig_Text ${LANG_PORTUGUESE} "Reset ALL OpenCPN configuration files"

#LangString SecDeleteConfigFile_Text ${LANG_ENGLISH} "Delete config file (opencpn.ini)"
LangString SecDeleteConfigFile_Text ${LANG_PORTUGUESE} "Delete config file (opencpn.ini)"

#LangString SecDeleteChartDB_Text ${LANG_ENGLISH} "Delete Chart Database file (CHRTLIST.DAT)"
LangString SecDeleteChartDB_Text ${LANG_PORTUGUESE} "Delete Chart Database file (CHRTLIST.DAT)"

#LangString SecDeleteSENC_Text ${LANG_ENGLISH} "Delete SENC directory"
LangString SecDeleteSENC_Text ${LANG_PORTUGUESE} "Delete SENC directory"

#LangString SecDeleteCM93_Text ${LANG_ENGLISH} "Delete CM93 Directory"
LangString SecDeleteCM93_Text ${LANG_PORTUGUESE} "Delete CM93 Directory"

#LangString SecDeleteLogFile_Text ${LANG_ENGLISH} "Delete Log file (opencpn.log)"
LangString SecDeleteLogFile_Text ${LANG_PORTUGUESE} "Delete Log file (opencpn.log)"

#LangString SecDeleteNavobjFile_Text ${LANG_ENGLISH} "Delete Navobject file (navobj.xml)"
LangString SecDeleteNavobjFile_Text ${LANG_PORTUGUESE} "Delete Navobject file (navobj.xml)"

#LangString SecSetConfig_Text ${LANG_ENGLISH} "OpenCPN Configuration Settings"
LangString SecSetConfig_Text ${LANG_PORTUGUESE} "OpenCPN Configuration Settings"

#LangString SecSetConfigLang_Text ${LANG_ENGLISH} "Set language to $LANG_NAME"
LangString SecSetConfigLang_Text ${LANG_PORTUGUESE} "Set language to $LANG_NAME"

#LangString SecSetConfigChartDir_Text ${LANG_ENGLISH} "Select Chart Directories"
LangString SecSetConfigChartDir_Text ${LANG_PORTUGUESE} "Select Chart Directories"

#LangString SecGrpResetConfig_Desc ${LANG_ENGLISH} "Deletes ALL files and subdirectories in the configuration folder."
LangString SecGrpResetConfig_Desc ${LANG_PORTUGUESE} "Deletes ALL files and subdirectories in the configuration folder."
...
LangString SecDeleteConfigFile_Desc ${LANG_PORTUGUESE} "Deletes the configuration file. This file helds also Routes and Waypoints."

#LangString SecDeleteChartDB_Desc ${LANG_ENGLISH} "Deletes the Chart DB file."
LangString SecDeleteChartDB_Desc ${LANG_PORTUGUESE} "Deletes the Chart DB file."

#LangString SecDeleteSENC_Desc ${LANG_ENGLISH} "Deletes the SENC subfolder which helds the Bitmaps and S57 chart cache files."
LangString SecDeleteSENC_Desc ${LANG_PORTUGUESE} "Deletes the SENC subfolder which helds the Bitmaps and S57 chart cache files."

#LangString SecDeleteCM93_Desc ${LANG_ENGLISH} "Deletes the cm93 subfolder which helds the cached cm93 chart outlines."
LangString SecDeleteCM93_Desc ${LANG_PORTUGUESE} "Deletes the cm93 subfolder which helds the cached cm93 chart outlines."
...
LangString SecDeleteNavobjFile_Desc ${LANG_PORTUGUESE} "Deletes the file 'navobj.xml' in the config folder. This file contains the Tracks."

#LangString SecDeleteLogFile_Desc ${LANG_ENGLISH} "Deletes the OpenCPN log file 'opencpn.log'."
LangString SecDeleteLogFile_Desc ${LANG_PORTUGUESE} "Deletes the OpenCPN log file 'opencpn.log'."

#LangString SecGrpShortcuts_Desc ${LANG_ENGLISH} "Creates shortcuts in both, the Start Menu and on the Desktop."
LangString SecGrpShortcuts_Desc ${LANG_PORTUGUESE} "Creates shortcuts in both, the Start Menu and on the Desktop."
...
LangString SecShortcutStartmenu_Desc ${LANG_PORTUGUESE} "Creates shortcuts for OpenCPN and the Uninstaller in the Start Menu - configurable on the next page."

#LangString SecShortcutDesktop_Desc ${LANG_ENGLISH} "Creates a shortcut for OpenCPN on the Desktop."
LangString SecShortcutDesktop_Desc ${LANG_PORTUGUESE} "Creates a shortcut for OpenCPN on the Desktop."
...
LangString SecSetConfig_Desc ${LANG_PORTUGUESE} "Preconfigure the language setting and the chart dir(s) for OpenCPN. When selected a separate page is shown for configuration."

#LangString UnSecDeleteConfigFolder_Desc ${LANG_ENGLISH} "Deletes the config folder and all its files and subdirectories."
LangString UnSecDeleteConfigFolder_Desc ${LANG_PORTUGUESE} "Deletes the config folder and all its files and subdirectories."

#LangString Uninstall_Link ${LANG_ENGLISH} "Uninstall OpenCPN 3.3.1117"
LangString Uninstall_Link ${LANG_PORTUGUESE} "Uninstall OpenCPN 3.3.1117"

#LangString Page_TypeInst_Title ${LANG_ENGLISH} "Previous Installations"
LangString Page_TypeInst_Title ${LANG_PORTUGUESE} "Previous Installations"
...
LangString Page_TypeInst_Subtitle ${LANG_PORTUGUESE} "$MULTIPLE_INSTALLS installations of OpenCPN found.$\r$\nChoose how you want to install OpenCPN."

#LangString Page_TypeInst_Title_1 ${LANG_ENGLISH} "Already Installed"
LangString Page_TypeInst_Title_1 ${LANG_PORTUGUESE} "Already Installed"

#LangString Page_TypeInst_Subtitle_1 ${LANG_ENGLISH} "Found installed version of OpenCPN.$\r$\nChoose how you want to install OpenCPN."
LangString Page_TypeInst_Subtitle_1 ${LANG_PORTUGUESE} "Found installed version of OpenCPN.$\r$\nChoose how you want to install OpenCPN."

#LangString Page_TypeInst_Title_Exists ${LANG_ENGLISH} "Version Already Installed"
LangString Page_TypeInst_Title_Exists ${LANG_PORTUGUESE} "Version Already Installed"

#LangString Page_TypeInst_Subtitle_Exists ${LANG_ENGLISH} "OpenCPN 3.3.1117 is already installed.$\r$\nChoose how you want to install OpenCPN."
LangString Page_TypeInst_Subtitle_Exists ${LANG_PORTUGUESE} "OpenCPN 3.3.1117 is already installed.$\r$\nChoose how you want to install OpenCPN."
...
LangString Label_TypeInst_Reinstall_Text ${LANG_PORTUGUESE} "OpenCPN 3.3.1117 is already installed on your system. You can reinstall the version now using the previous settings. If you wish to install the program with different settings, cancel installation and un-install the existing version first. Click Next to continue."

#LangString RB_Reinstall_TypeInst_Text ${LANG_ENGLISH} "Reinstall using previous settings"
LangString RB_Reinstall_TypeInst_Text ${LANG_PORTUGUESE} "Reinstall using previous settings"
...
LangString Label_TypeInst_Upgrade_Text ${LANG_PORTUGUESE} "An older version of OpenCPN is installed on your system. Select the installation type you want to perform and click Next to continue."

#LangString RB_Upgrade_TypeInst_Text ${LANG_ENGLISH} "Upgrade OpenCPN using previous settings (recommended)"
LangString RB_Upgrade_TypeInst_Text ${LANG_PORTUGUESE} "Upgrade OpenCPN using previous settings (recommended)"
...
LangString Label_TypeInst_Downgrade_Text ${LANG_PORTUGUESE} "A newer version of OpenCPN is installed on your system. It is not recommended to downgrade to an older version. Select the installation type you want to perform and click Next to continue."

#LangString RB_Downgrade_TypeInst_Text ${LANG_ENGLISH} "Downgrade OpenCPN using previous settings (recommended)"
LangString RB_Downgrade_TypeInst_Text ${LANG_PORTUGUESE} "Downgrade OpenCPN using previous settings (recommended)"
...
LangString Label_TypeInst_Parallel_Text ${LANG_PORTUGUESE} "Setup has detected several installed versions of OpenCPN on your system. It is recommended to have only one version of OpenCPN installed at a time. Select the operation you want to perform and click Next to continue."

#LangString RB_Parallel_TypeInst_Text ${LANG_ENGLISH} "Parallel Installation (advanced users)"
LangString RB_Parallel_TypeInst_Text ${LANG_PORTUGUESE} "Parallel Installation (advanced users)"

#LangString EmptyString ${LANG_ENGLISH} ""
LangString EmptyString ${LANG_PORTUGUESE} ""

#LangString Show_Readme_Text ${LANG_ENGLISH} "Show Install Log file"
LangString Show_Readme_Text ${LANG_PORTUGUESE} "Show Install Log file"

#LangString Finish_Link_Text ${LANG_ENGLISH} "OpenCPN website (Internet connection required)"
LangString Finish_Link_Text ${LANG_PORTUGUESE} "OpenCPN website (Internet connection required)"

#LangString Finish_Link_URL ${LANG_ENGLISH} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.1117"
LangString Finish_Link_URL ${LANG_PORTUGUESE} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.1117"
...
LangString Msg_UAC_Admin_Retry ${LANG_PORTUGUESE} "This $Inst_Or_Uninst requires admin access!$\r$\nPlease log on as an Administrator and try again."

#LangString Msg_UAC_Admin_Abort ${LANG_ENGLISH} "This $Inst_Or_Uninst requires admin privileges, aborting!"
LangString Msg_UAC_Admin_Abort ${LANG_PORTUGUESE} "This $Inst_Or_Uninst requires admin privileges, aborting!"

#LangString Msg_UAC_Logon_Abort ${LANG_ENGLISH} "Logon service not running, aborting!"
LangString Msg_UAC_Logon_Abort ${LANG_PORTUGUESE} "Logon service not running, aborting!"

#LangString Msg_UAC_No_Elevation ${LANG_ENGLISH} "Unable to elevate , error $0"
LangString Msg_UAC_No_Elevation ${LANG_PORTUGUESE} "Unable to elevate , error $0"
...
LangString Msg_Error_Remove_InstDir ${LANG_PORTUGUESE} "The installation directory$\r$\n'$INSTDIR'$\r$\ncould not be removed because it is not empty."

#LangString Msg_Path_Invalid ${LANG_ENGLISH} "The entered path is invalid!$\r$\n$\r$\nPlease check your input."
LangString Msg_Path_Invalid ${LANG_PORTUGUESE} "The entered path is invalid!$\r$\n$\r$\nPlease check your input."
...
LangString Msg_Path_Installation_Exists ${LANG_PORTUGUESE} "There already exists an installation of OpenCPN in the given path.$\r$\nIf you wish to use this path, first uninstall the version. Or select another path for this installation."
...
LangString Msg_Uninstall_Old_Versions ${LANG_PORTUGUESE} "Setup has detected at least one older version of OpenCPN which is not compatible with the new version control.$\r$\nIt is recommended to first uninstall all of these installations (this does not affect your Config files) and clean-up the Registry.$\r$\nIf you click Yes on the next page a listbox with all installation locations will be shown and you will have the possibility to select the installations you wish to uninstall.$\r$\nIf you are unsure about possible other previous installations than those shown in the listbox, you can also perform a scan of the entire Harddisk (ATTENTION: This may take several minutes) to find all install locations (recommended).$\r$\n$\r$\nDo you want to uninstall the old version(s)?"

#LangString Msg_Not_All_Old_Uninstalled ${LANG_ENGLISH} "You have not uninstalled all previous installations.$\r$\n$\r$\nDo you want to continue anyway?"
LangString Msg_Not_All_Old_Uninstalled ${LANG_PORTUGUESE} "You have not uninstalled all previous installations.$\r$\n$\r$\nDo you want to continue anyway?"
...
LangString Msg_Uninstaller_Param_Help ${LANG_PORTUGUESE} "Uninstaller Help$\r$\n$\r$\nUse the command line or a shortcut to run the uninstaller:$\r$\n$INSTDIR\Uninstall 3.3.1117.exe [/?] | [/S], [/type=X]$\r$\n$\r$\nParameters:$\r$\n/?$\tshows this help message box$\r$\n/S$\truns the uninstaller in silent mode$\r$\n$\twill do a full uninstall if called without any type parameter$\r$\n/type=X$\tX must be a digit between 1 and 5$\r$\n$\t1 = Removes only the program files$\r$\n$\t2 = Removes only the program files + preconfig RegKey$\r$\n$\t3 = Removes the program files + config folder$\r$\n$\tpreserves the preconfig RegKey$\r$\n$\t4 = Deletes only the config folder$\r$\n$\t5 = Deletes only the preconfig RegKey$\r$\n$\r$\nEntering any other number or value will quit the uninstaller with a message box without removing or deleting anything."
...
LangString Msg_Unknown_Type_Param ${LANG_PORTUGUESE} "The entered value '$9' for the type parameter is not valid!$\r$\nUse $INSTDIR\Uninstall 3.3.1117.exe /?$\r$\nto see a list of valid values."

;added on 2010-10-16
#LangString SecGrpShortcuts_Text ${LANG_ENGLISH} "Create Shortcuts"
LangString SecGrpShortcuts_Text ${LANG_PORTUGUESE} "Create Shortcuts"

#LangString SecShortcutStartmenu_Text ${LANG_ENGLISH} "Add Shortcuts to the Start Menu"
LangString SecShortcutStartmenu_Text ${LANG_PORTUGUESE} "Add Shortcuts to the Start Menu"

#LangString SecShortcutDesktop_Text ${LANG_ENGLISH} "Create Shortcut on the Desktop"
LangString SecShortcutDesktop_Text ${LANG_PORTUGUESE} "Create Shortcut on the Desktop"

#LangString Installation_Delete_Config ${LANG_ENGLISH} "Delete (existing) Config Subdirectories/ Files"
LangString Installation_Delete_Config ${LANG_PORTUGUESE} "Delete (existing) Config Subdirectories/ Files"

;added on 2010-10-17
#LangString Banner_Scan_Drive ${LANG_ENGLISH} "Scanning Drive $9"
LangString Banner_Scan_Drive ${LANG_PORTUGUESE} "Scanning Drive $9"

#LangString Banner_Installation_Found_Singular ${LANG_ENGLISH} "Found $counter_tmp installation"
LangString Banner_Installation_Found_Singular ${LANG_PORTUGUESE} "Found $counter_tmp installation"

#LangString Banner_Installation_Found_Plural ${LANG_ENGLISH} "Found $counter_tmp installations"
LangString Banner_Installation_Found_Plural ${LANG_PORTUGUESE} "Found $counter_tmp installations"

;added on 2010-10-18
#LangString UnSecDeleteConfigFolder_Text ${LANG_ENGLISH} "Delete Config folder"
LangString UnSecDeleteConfigFolder_Text ${LANG_PORTUGUESE} "Delete Config folder"

;added on 2010-10-21
#LangString Uninstall_Folder_Name ${LANG_ENGLISH} "Uninstall"
LangString Uninstall_Folder_Name ${LANG_PORTUGUESE} "Uninstall"

;added on 2011-06-13
#LangString ^NameDA ${LANG_ENGLISH} "OpenCPN Version 3.3.1117"
LangString ^NameDA ${LANG_PORTUGUESE} "OpenCPN versão 3.3.1117"
...
LangString License_Message ${LANG_PORTUGUESE} "OpenCPN is software libre. You are encouraged and legally entitled to copy, reinstall, modify, and redistribute this program for yourself and your friends under the terms of the GPL. $\r$\nSmooth sailing!"
...
LangString Installer_Unsupported_XP_SP_Version ${LANG_PORTUGUESE} "Your Windows XP Service Pack version is not supported (it's too old)!$\r$\nYou need at least Windows XP SP3."
